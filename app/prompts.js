...
module.exports = info => {
  return [
    ...
    },
    {
      ...
      message: '(2/10) What is your email address?',
    ...
    },
    {
      ...
      message: '(4/10) What is the name of your project?',
    ...
    },
    {
      ...
      message: '(5/10) What is the version of your project?',
      default: '0.0.1'
    },
    {
      type: 'input',
      name: 'projectDescription',
      message: '(6/10) What is the description of your project?',
      default: 'Angular library built with ❤ using ngx-library yeoman generator.'
    },
    {
      type: 'input',
      name: 'projectKeywords',
      message: '(7/10) What keywords best describe your project (comma-separated)?'
    },
    {
      type: 'input',
      name: 'moduleName',
      validate: validators.validateModuleName,
      message: '(8/10) What is the name of your main Angular module?',
      default: 'my-ng-module'
    },
    {
      type: 'list',
      name: 'ngVersion',
      message: '(9/10) What minimal version of Angular do you want to base your library upon?',
      choices: [
    ...
    },
    {
      ...
      message: '(10/10) What Angular modules will your library use?',
      choices: NG_MODULES
    }
  ];
};
