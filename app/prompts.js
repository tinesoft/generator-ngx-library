...
module.exports = info => {
  return [
    ...
    },
    {
      type: 'list',
      name: 'ngVersion',
      message: '(8/13) What minimal version of Angular do you want to base your library upon?',
      choices: [
    ...
    },
    {
      ...
      message: '(9/13) What prefix would you like to use to name your components, directives,...?',
      default: 'my-lib'
    },
    {
      type: 'checkbox',
      ...
      message: '(10/13) What Angular modules will your library use?',
      choices: NG_MODULES
    },
    {
      type: 'confirm',
      name: 'useGreenkeeper',
      message: '(11/13) Do You want to use Greenkeepeer (to automatically keep your dependencies up-to-date)?',
      default: true
    },
    {
      type: 'confirm',
      name: 'useCompodoc',
      message: '(12/13) Do You want to use Compodoc (to generate your Angular project documentation)?',
      default: false
    },
    {
      type: 'confirm',
      name: 'enforceNgGitCommitMsg',
      message: '(13/13) Do You want to enforce Angular Git Commit Messages Guideline (to autogenerate CHANGELOG.md file)?',
      default: true
    }
  ];
};
